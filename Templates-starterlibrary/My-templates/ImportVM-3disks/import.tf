...
variable "disk_2_unit_number" {
  description = ""
}

variable "disk_2_path" {
  description = ""
}

variable "disk_2_label" {
  description = ""
}

variable "disk_2_size" {
  description = ""
}

variable "disk_2_datastore_id" {
  description = ""
}
...
resource "vsphere_virtual_machine" "vm_1" {
  ...
  disk {
    ...
    disk {
    unit_number = "${var.disk_2_unit_number}"
    path = "${var.disk_2_path}"
    label = "${var.disk_2_label}"
    size = "${var.disk_2_size}"
    datastore_id = "${var.disk_2_datastore_id}"
  }
}
